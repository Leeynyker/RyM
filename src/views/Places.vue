  ...
  <div class="main-lugares">
    ...
    <div class="contenedor">
      ...
      >
        ...
        >
        <va-card-content>
          <h3>Type:</h3><span>{{ lugar.type }}</span>
          <h3>Dimension:</h3> <p>{{ lugar.dimension }}</p> </va-card-content
        >
      </va-card>
    </div>
    ...
    <va-modal v-model="verLugar" no-padding>
      <template #content="{ ok }">
        ...
        <va-card-actions>
          <va-button @click="ok" color="#227360">Ok</va-button>
        </va-card-actions>
      </template>
    </va-modal>
  </div>
...
.tarjeta:hover {
  box-shadow: 3px 3px 18px 4px hsla(166, 54%, 29%, 0.485);
  cursor: pointer;
}
